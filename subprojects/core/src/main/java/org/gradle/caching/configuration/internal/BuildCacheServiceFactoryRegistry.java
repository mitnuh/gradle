...
public class BuildCacheServiceFactoryRegistry {
    ...
    public BuildCacheServiceFactoryRegistry(DependencyInjectingServiceLoader serviceLoader) {
        this.factories = findFactories(serviceLoader, getClass().getClassLoader());
    }
